...
- pin_list:
  ...
  - {pin_num: '37', peripheral: GPIOA, signal: 'GPIO, 17', pin_signal: PTA17/SPI0_MISO/SPI0_MOSI, pull_enable: enable}
...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t porta17_pin37_config = {/* Internal pull-up resistor is enabled */
                                                    kPORT_PullUp,
    ...
    PORT_SetPinConfig(PORTA, 17U, &porta17_pin37_config);
